...
public class DBAppointment{
	...
	public static int addAppointment(String description, User leader, MeetTime time){
		...
		"(brukerNavn, beskrivelse, startTime, sluttTime, startMinutt, sluttMinutt, dag, uke, m�ned, �r) VALUES ('"
	...
	public static void editAppointment(Appointment app){
		...
		query.append("m�ned = '" + app.getMeetingTime().getMonth() + "',");
		query.append("�r = '" + app.getMeetingTime().getYear() + "',");
